<%@ Page Title="" Language="C#" MasterPageFile="~/SiteCADRO.Master" AutoEventWireup="true" CodeBehind="solicitantemaster.aspx.cs" Inherits="WebApplication1.solicitantemaster" %>
        ...
        <div class="row">
            <div class="col">
                <dx:ASPxGridView ID="gvSolicitudes" ClientInstanceName="gvSolicitudes" OnHtmlRowPrepared="gvSolicitudes_HtmlRowPrepared" KeyFieldName="id" Width="100%" 
                    ...
                    <Columns>
                        <dx:GridViewCommandColumn VisibleIndex="0" Caption="Asignar" ButtonType="Image" MinWidth="280" Width="36%">
                            <CustomButtons>
