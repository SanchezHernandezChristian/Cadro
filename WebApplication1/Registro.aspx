...
<body>
                ...
                <div class="form-group" id="div_cedula">
                    <div class="row  justify-content-center" >
                        <div class="form-label-group col-md-5">
                            ...
                            <dx:ASPxTextBox MaxLength="10" ID="txtCedula" type="number" onkeypress="return soloNumeros(event);" ClientInstanceName="txtCedula" runat="server" Theme="Material" CssClass="form-control" ClientEnabled="true">
                            </dx:ASPxTextBox>
 ...
 <%--  
                                ...
                                <div class="form-group">
                                    <div class="row" >
                                        <div class="form-label-group col-md-4">
                                            ...
                                            <dx:ASPxLabel runat="server" Width="100%" ID="ASPxLabel1" Text="Comprobante de pago" ForeColor="#D6D2C9" Theme="Material" CssClass="form-control">
                                            </dx:ASPxLabel>
                                            <br />
                                            <asp:FileUpload ID="FileUpload2" runat="server" BackColor="White" Width="280px" Height="30px"/>
                                            <br />
                                            <br />
             ...
             ControlToValidate="FileUpload2" ForeColor="Red">
        </asp:RegularExpressionValidator>
                                            </div>
                                        <div class="form-label-group col-md-4">
                                            <label>Credencial de elector</label>
                                            <dx:ASPxLabel runat="server" Width="100%" ID="ASPxLabel2" Text="Credencial de pago" ForeColor="#D6D2C9" Theme="Material" CssClass="form-control">
                                            </dx:ASPxLabel>
                                            <br />
                                            <asp:FileUpload ID="FileUpload3" runat="server" BackColor="White" Width="280px" Height="30px"/>
                                            <br />
                                            <br />
                                            <asp:RegularExpressionValidator 
             ...
             ErrorMessage="Solamente archivos PDF" 
             ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.pdf)$" 
             ControlToValidate="FileUpload3" ForeColor="Red">
        </asp:RegularExpressionValidator>
                                            </div>
                                        <div class="form-label-group col-md-4">
                                            <label>Comprobante de domicilio</label>
                                            <dx:ASPxLabel runat="server" Width="100%" ID="ASPxLabel3" Text="Comprobante de domicilio" ForeColor="#D6D2C9" Theme="Material" CssClass="form-control">
                                            </dx:ASPxLabel>
                                            <br />
                                            <asp:FileUpload ID="FileUpload4" runat="server" BackColor="White" Width="280px" Height="30px"/>
                                            <br />
                                            <br />
                                            <asp:RegularExpressionValidator 
             ...
             ErrorMessage="Solamente archivos PDF" 
             ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.pdf)$" 
             ControlToValidate="FileUpload4" ForeColor="Red">
        </asp:RegularExpressionValidator>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="form-label-group col-md-4">
                                            ...
                                            <dx:ASPxLabel runat="server" Width="100%" ID="ASPxLabel4" Text="Comprobante de domicilio" ForeColor="#D6D2C9" Theme="Material" CssClass="form-control">
                                            </dx:ASPxLabel>
                                            <br />
                                            <asp:FileUpload ID="FileUpload5" runat="server" BackColor="White" Width="280px" Height="30px"/>
                                            <br />
                                            <br />
                                            <asp:RegularExpressionValidator 
             ...
             ErrorMessage="Solamente archivos PDF" 
             ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.pdf)$" 
             ControlToValidate="FileUpload5" ForeColor="Red">
        </asp:RegularExpressionValidator>
                                        </div>
                                        <div class="form-label-group col-md-4">
                                            <label>Curriculum Vitae</label>
                                            <dx:ASPxLabel runat="server" Width="100%" ID="ASPxLabel5" Text="Comprobante de domicilio" ForeColor="#D6D2C9" Theme="Material" CssClass="form-control">
                                            </dx:ASPxLabel>
                                            <br />
                                            <asp:FileUpload ID="FileUpload6" runat="server" BackColor="White" Width="280px" Height="30px"/>
                                            <br />
                                            <br />
                                            <asp:RegularExpressionValidator 
             ...
             ErrorMessage="Solamente archivos PDF" 
             ValidationExpression="^(([a-zA-Z]:)|(\\{2}\w+)\$?)(\\(\w[\w].*))+(.pdf)$" 
             ControlToValidate="FileUpload6" ForeColor="Red">
        </asp:RegularExpressionValidator>
                                        </div>
                                        <div class="form-label-group col-md-4">
